...
import PersonalReferencesForm from '../../borrower/PersonalReferencesForm';

const ReferencePersonModal = ({ isOpen, onRequestClose, onPaymentSubmit }) => {
    return (
        <Modal
            isOpen={isOpen}
...
export default ReferencePersonModal;